...
while True:
    ...
    if alarm:
        ...
        if not sensor.value:
            while True:
                ...
                funhouse.peripherals.set_dotstars(BLACK , RED, BLACK, BLUE, BLACK)
                pixel.fill((0, 0, 0))
                ...
                if funhouse.peripherals.button_sel or funhouse.peripherals.button_up or funhouse.peripherals.button_down:
                    funhouse.peripherals.set_dotstars(MYRTLE, MYRTLE, LIGHT_GREEN, MYRTLE, MYRTLE)
                    pixel.fill((51, 0, 0))
                    time.sleep(2)
    ...
    if funhouse.peripherals.captouch6:
        ...
        while True:
            ...
            pixel.fill((0, 0, 0))
            time.sleep(.5)
            funhouse.peripherals.set_dotstars(NAVY, NAVY, NAVY, NAVY, NAVY)
            pixel.fill((0, 0, 85))
            funhouse.set_text(" ", alarm_label)
            time.sleep(.5)
            if funhouse.peripherals.button_sel or funhouse.peripherals.button_up or funhouse.peripherals.button_down:
